...
du vil tilf&oslash;je systemet. Kollonnerne skal have f&oslash;lgende headers: <b>email</b>, <b>loginname</b>, <b>password</b>. Alle andre kollonner vil blive tilf&oslash;jet som admin attributter.
 <b>Advarsel</b>: filen skal v&aelig;re en ren tekstfil. Upload ikke bin&aelig;re filer, som fx et Word dokument.
  ...
  'If you check "Test Output", you will get the list of parsed emails on screen, and the database will not be filled with the information. This is useful to find out whether the format of your file is correct. It will only show the first 50 records.' => 'Hvis du v&aelig;lger "Test visning", vil listen med emails blive parset til sk&aelig;rmen, og databasen vil ikke modtage disse informationer. Det kan bruges til at finde ud af om filens format er korrekt eller ej. Der vises kun de f&oslash;rste 50 records.',
  ...
  'Test output:There should only be ONE email per line.If the output looks ok, go Back to resubmit for real' => 'Test visning:<br/>Der b&oslash;r kun v&aelig;re EN email per linje.<br/>Hvis det ser fint ud, s&aring; g&aring; <a href="javascript:history.go(-1)">Tilbage</a> for at sende for alvor<br/><br/>',  
  'List for' => 'Liste for',
'login' => 'log ind',
