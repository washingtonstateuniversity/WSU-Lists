...
'Sorry, only super users can purge RSS items from the database' => 'Sorry, only super users can purge RSS items from the database',
  'All entries that are older than the number of days you enter will be purged.' => 'All entries that are older than the number of days you enter will be purged.',
);
?>