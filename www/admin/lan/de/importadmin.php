...
$lan = array(
  ...
  'Test output:There should only be ONE email per line.If the output looks ok, go Back to resubmit for real' => 'Test-Durchlauf<br/>Es sollte nur 1 E-Mail-Adresse pro Zeile zu sehen sein.<br/>
