...
# do not translate email, loginname and password
  '   The file you upload will need to contain the administrators you want to add to the system. The columns need to have the following headers: email, loginname, password. Any other columns will be added as admin attributes.  Warning: the file needs to be plain text. Do not upload binary files like a Word Document.   ' => 'L\'archivio da caricare deve contenere gli amministratori verr&agrave; aggiunto al sistema. Le colonne dovranno avere le seguenti intestazioni: <b>email</b>, <b>loginname</b>, <b>password</b>. Ogni altra colonna verr&agrave; aggiunta come attributo degli amministratori. <b>Attenzione</b>: l\'archivio deve essere di testo semplice. Non caricare archivi binari come documenti Word.',
  ...
  'If you check "Test Output", you will get the list of parsed emails on screen, and the database will not be filled with the information. This is useful to find out whether the format of your file is correct. It will only show the first 50 records.' => 'Se spuntato "Verifica formato archivio", otterrete a video la lista delle email controllate, e le informazioni non saranno scritte sul database. Questo &egrave; utile per verificare se il formato dell\'archivio &egrave; corretto. Verranno visualizzati solo i primi 50 records.',
  ...
  'Test output:There should only be ONE email per line.If the output looks ok, go Back to resubmit for real' => 'Verifica formato archivio:<br>Deve esserci solo UNA email per linea.<br>Se &egrave; corretto, vai a <a href="javascript:history.go(-1)">Back</a> per risottomettere per reale<br><br>',
  'List for' => 'Lista per',
  'login' => 'login',
);
?>
