...
N&atilde;o importa se est&aacute; em mai&uacute;sculas ou min&uacute;sculas.
    ...
    <br/>',
'The following limits are set by your server: Maximum size of a total data sent to server: %s Maximum size of each individual file: %s' => 'Os seguintes limites s&atilde;o estabelecidos pelo seu servidor:<br/>
...
'If you check "Show Warnings", you will get warnings for invalid records. Warnings will only be shown if you check "Test Output". They will be ignored when actually importing. ' => 'Se voc&ecirc; verificar "Mostar Alertas", voc&ecirc; ver&aacute; os alertas sobre registros inv&aacute;lidos. Os alertas s&oacute; ser&atilde;o exibilidos se voc&ecirc; acionar o "Testar Resultados". Eles ser&atilde;o ignorados durante a importa&ccedil;&atilde;o final. ',
...
'If you check "Overwrite Existing", information about a subscriber in the database will be replaced by the imported information. Subscribers are matched by email or foreign key.' => 'If you check "Overwrite Existing", information about a user in the database will be replaced by the imported information. Users are matched by email or foreign key.',
'If you check "Retain Old Email", a conflict of two emails being the same will keep the old one and add "duplicate" to the new one. If you don&quot;t check it, the old one will get "duplicate" and the new one will take precedence.' => 'If you check "Retain Old User Email", a conflict of two emails being the same will keep the old one and add "duplicate" to the new one. If you don\'t check it, the old one will get "duplicate" and the new one will take precedence.',
'If you choose "send notification email" the subscribers you are adding will be sent the request for confirmation of subscription to which they will have to reply. This is recommended, because it will identify invalid emails.' => 'If you choose "send notification email" the users you are adding will be sent the request for confirmation of subscription to which they will have to reply. This is recommended, because it will identify invalid emails.',
