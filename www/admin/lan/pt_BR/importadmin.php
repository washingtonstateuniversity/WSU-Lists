...
$lan = array(
 ...
 <b>Aten&ccedil;&atilde;o</b>: o arquivo deve ser tipo texto simples. N&atilde;o fa&ccedil;a upload de arquivos bin&aacute;rios como Documentos Word.
  ...
  'Test output:There should only be ONE email per line.If the output looks ok, go Back to resubmit for real' => 'Testar Resultados:<br/>Deve haver s&oacute; UM email por linha.<br/>Se os resultados parecem corretos, <a href="javascript:history.go(-1)">Volte</a> para reenviar de fato<br/><br/>',  
  'List for' => 'Listar por',
'login' => 'conectar',
