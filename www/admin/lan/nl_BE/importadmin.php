...
die je aan het systeem wilt toevoegen. De kolommen moeten de volgende headers hebben: <b>email</b>, <b>loginname</b>, <b>password</b>. Alle andere kolommen zullen worden toegevoegd als admin attributen.
 <b>Opgelet</b>: het bestand mag ENKEL TEKST bevatten. Upload geen binaire bestanden zoals een Word Document.
  ...
  'Test output:There should only be ONE email per line.If the output looks ok, go Back to resubmit for real' => 'Test uitvoer:<br>Er zou 1 email per lijn moeten zijn.<br>Als de uitvoer er goed uit ziet, ga dan verder <a href="javascript:history.go(-1)">Terug</a> om voor echt voor te leggen<br><br>',
  'List for' => 'Lijst voor',
'login' => 'meld aan',
