...
$lan = array(
 ...
 <b>Attention</b>: le fichier doit &ecirc;tre au format texte.  Ne t&eacute;l&eacute;chargez pas de fichier binaire comme un Document Word.
  ...
  'Test output:There should only be ONE email per line.If the output looks ok, go Back to resubmit for real' => 'R&eacute;sultat test:<br/>Il ne devrait y avoir qu&rsquo;UN seul email par ligne.<br/>Si le r&eacute;sultat vous semble probant, retournez <a href="javascript:history.go(-1)">en arri&egrave;re</a> et ex&eacute;cutez votre requ&ecirc;te pour de bon<br/><br/>',  
  'List for' => 'Liste pour',
'login' => 'connexion',
